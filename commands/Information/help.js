    ...
    try {
      ...
      if (!commandopt) {
        ...
        let button_tutorial = new MessageButton()
          ...
          .setEmoji(``)
          .setLabel(`Invite`)
          .setURL(`https://discord.com/api/oauth2/authorize?client_id=989152122656399453&permissions=8&scope=bot+applications.commands`);
        ...
        let embed = new MessageEmbed()
          ...
          .addField(
            `** Developer Info **`,
            `** Name : Real_IceyDev#3339 (<@711964126301126696>) | [Support](https://discord.gg/5ZdjKf8RKc ) | [Github](https://github.com/ReallyDev) **`
          );
        await interaction
          .followUp({
            embeds: [embed],
